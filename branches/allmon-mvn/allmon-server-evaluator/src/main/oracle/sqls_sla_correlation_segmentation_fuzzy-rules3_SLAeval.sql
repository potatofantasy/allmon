...
begin
    ...
    AM_CONTROL_FUZZY.run_evaluation(to_date('2012-01-08 17:50:00', 'YYYY-MM-DD HH24:MI:SS'));
end;
...
--and r.ts > to_date('2012-01-03 23:40:00', 'YYYY-MM-DD HH24:MI:SS')
--and r.ts < to_date('2012-01-03 23:50:00', 'YYYY-MM-DD HH24:MI:SS')
  and r.ts > to_date('2012-01-08 17:50:00', 'YYYY-MM-DD HH24:MI:SS')
  and r.ts < to_date('2012-01-08 18:00:00', 'YYYY-MM-DD HH24:MI:SS')
