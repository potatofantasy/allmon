...
public class MetricMessageWrapperTest extends TestCase {
    ...
    public void testAdd() throws Exception {
        ...
        metricMessageWrapper.add(MetricMessageFactory.createClassMessage("className1", "method1", "classNameX", "methodNameX"));
        metricMessageWrapper.add(MetricMessageFactory.createClassMessage("className2", "method1", "classNameX", "methodNameX"));
    ...
    public void testAddWrapper() throws Exception {
        ...
        metricMessageWrapper2.add(MetricMessageFactory.createClassMessage("className1", "method1", "classNameX", "methodNameX"));
