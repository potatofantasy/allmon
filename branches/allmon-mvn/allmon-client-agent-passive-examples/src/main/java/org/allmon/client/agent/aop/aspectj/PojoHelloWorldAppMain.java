 ...
 * }</pre>
 */
public class PojoHelloWorldAppMain {
	
	
	public static void main(String[] args) throws InterruptedException {
		System.out.println("PojoHelloWorldAppMain - testMain");
		...
		PojoHelloWorldAppMain app = new PojoHelloWorldAppMain();
		app.method(bean);
	...
	private void method(HelloWorldImpl bean) throws InterruptedException {
		System.out.println("PojoHelloWorldAppMain - method");
		//for (int i = 0; i < 100; i++) {
			bean.printMessage();
	...
	private void methodWithException(HelloWorldImpl bean) {
		System.out.println("PojoHelloWorldAppMain - methodWithException");
		bean.printMessageE();
	}
