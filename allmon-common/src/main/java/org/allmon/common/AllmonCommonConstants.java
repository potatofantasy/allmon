...
public class AllmonCommonConstants {
    ...
    public final static boolean ALLMON_CLIENT_AGENT_ADVICES_VERBOSELOGGING = getInstance().getValueBoolean("allmon.client.agent.advices.allmonadvice.verboseLogging", false);
    public final static boolean ALLMON_CLIENT_AGENT_ADVICES_ACQUIREPARAMETERS = getInstance().getValueBoolean("allmon.client.agent.advices.allmonadvice.acquireCallParameters", false);
    public final static boolean ALLMON_CLIENT_AGENT_ADVICES_FINDCALLER = getInstance().getValueBoolean("allmon.client.agent.advices.allmonadvice.findCaller", false);
    ...
    // for receiver process
    public final static boolean ALLMON_SERVER_RECEIVER_VERBOSELOGGING = getInstance().getValueBoolean("allmon.server.receiver.verboselogging", false);
