...
public class SimpleStandard extends NotificationBroadcasterSupport implements
	...
	/*
	 * "SimpleStandard" does not provide any specific constructors. However,
	 * "SimpleStandard" is JMX compliant with regards to contructors because the
	 * default contructor SimpleStandard() provided by the Java compiler is
	 * public.
	 */
	 ...
	 * sense because it is not exposed in the "SimpleStandardMBean" interface.
	 * 
