...
select 
  NON EMPTY Crossjoin(Crossjoin({[MODULE].[ALL].Children}, {[PROCESSNAME].[ALL]}), {[Measures].[TOTALRUNTIME_MINS]}) ON COLUMNS,
  Crossjoin({[STARTDATETIME_YEAR].[ALL].Children}, {[STARTDATETIME_MONTH].[ALL].Children}) ON ROWS
