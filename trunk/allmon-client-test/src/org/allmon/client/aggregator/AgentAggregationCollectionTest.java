...
public class AgentAggregationCollectionTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                AgentAggregationCollection agentAggregationCollection = new AgentAggregationCollection();
                //agentAggregationCollection.setCorrelationExpression(new );
